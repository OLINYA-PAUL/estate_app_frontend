                    ...
                    >
                      ...
                      <div className="absolute bottom-0 left-0 p-6 w-full">
                        <div className="bg-gradient-to-br from-white/15 to-purple-500/15 backdrop-blur-xl border border-white/30 p-4 rounded-lg max-w-lg shadow-xl shadow-purple-500/10">
                          <span className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white px-2.5 py-0.5 rounded text-sm font-medium shadow-md shadow-purple-500/30">
                            Featured
                          </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                gradient: "from-indigo-400 via-purple-300 to-indigo-400",
              },
              {
                name: "Special Offers",
                query: "offer=true",
              ...
              >
                ...
                <div className="flex justify-between items-end">
                  ...
                  <span
                    className={`bg-gradient-to-r ${category.gradient} bg-clip-text text-transparent text-sm`}
                  >
                    View all →
                  </span>
                </div>
                ...
                >
                  ...
                  <div className="p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span
                        className={`text-xs px-2 py-1 rounded shadow-md ${
                          listing.type === "rent"
                            ? "bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-500 shadow-purple-500/30"
                            : "bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-500 shadow-cyan-500/30"
                        }`}
                      >
